...
// const mongo_url = "mongodb+srv://connectaftabali_db_user:kuneGjcKkmlntgvx@cluster0.8sbru9u.mongodb.net/?appName=Cluster0";
...
const session = require("expresprocess.env.SECRETconst flash = require("connect-flash");
...
//register demo user via passport
// app.get("/demouser", async (req, res) => {
//   let fakeuser = new user({
//     email: "aftabale4@gmail.com",
//     username: "ali_ale",
//   });
//   let registereduser = await user.register(fakeuser, "aftabali");
...
// app.use(router); // mount router to app
...
app.get("/listings/Rooms", async (req, res) => {
  let category = await listing.find({ category: "Rooms" }); // ← "Rooms" try kar
  console.log(category);
  res.render("listings/category.ejs", { category });
});
// app.get("/listings/Trending",async (req,res)=>{
//   let category=await listing.find({category:"Trending"});
//   console.log(category);
//   res.send("hii");
// });
//create new route
...
app.post(
  ...
  wrapAsync(async (req, res, next) => {
    ...
    const newlisting = new listing(req.body.list); //in html 52
